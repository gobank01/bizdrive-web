  ...
  return (
    <section className="bg-[linear-gradient(180deg,#f8fbff_0%,#fff_70%)] py-[72px] max-[620px]:py-[54px]">
      <div className="bx-container max-w-[680px] text-center">
        <div className="mx-auto mb-5 grid size-[78px] place-items-center rounded-full bg-brand-yellow/[.18] text-ink">
          <svg viewBox="0 0 24 24" aria-hidden="true" className="size-[36px] fill-none stroke-current [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:2.5]">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <Link href="/contact" className="btn btn-outline">กรอกฟอร์มติดต่อ</Link>
          <Link href="/ebooks" className="btn btn-outline">ดู eBook</Link>
          <Link href="/#class" className="btn btn-outline">ดูคลาสเรียน</Link>
        </div>
      </div>
    </section>
  );
