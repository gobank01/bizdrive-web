  ...
  return (
    <section className="bg-[linear-gradient(180deg,#f8fbff_0%,#fff_70%)] py-[72px] max-[620px]:py-[54px]">
      <div className="bx-container max-w-[760px] text-center">
        <div className="mx-auto mb-7 grid h-[110px] w-[110px] place-items-center rounded-full bg-brand-blue text-[60px] font-extrabold text-brand-yellow shadow-brand max-[620px]:h-[90px] max-[620px]:w-[90px] max-[620px]:text-[44px]">
          404
        </div>
        ...
        <div className="mb-9 flex flex-wrap justify-center gap-3">
          <a href="/" className="btn btn-primary max-[620px]:w-full max-[620px]:max-w-[300px]">
            กลับหน้าแรก
          </a>
          <a href="/#class" className="btn btn-outline max-[620px]:w-full max-[620px]:max-w-[300px]">
            ดูคลาสเรียน
          </a>
        </div>
          ...
          {PLAN_ORDER.map((slug) => {
            ...
            return (
              <a
                ...
                className="group rounded-lg border border-line bg-white px-4 py-4 transition-[transform,border-color,box-shadow] duration-200 hover:-translate-y-0.5 hover:border-brand-sky/45 hover:shadow-brand-sm"
              >
