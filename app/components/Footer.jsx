          ...
          <div>
            ...
            <ul className="mt-3 grid list-none gap-2.5 text-[13.5px] max-[620px]:items-center">
              <li>
                ...
                >
                  <Image src="/assets/brand/contact/line.svg" alt="" width={20} height={20} className="size-[20px] flex-shrink-0" />
              ...
              <li>
                <a
                  ...
                  className="group inline-flex items-center gap-2.5 rounded-lg border border-white/10 bg-white/[.04] px-3 py-2 text-white transition-[border-color,background-color] duration-150 hover:border-white/25 hover:bg-white/[.08]"
                >
                  <Image src="/assets/brand/contact/phone.svg" alt="" width={26} height={26} className="size-[26px] flex-shrink-0 rounded-md" />
                  <span className="flex flex-col">
              ...
              <li>
                <a
                  ...
                  className="group inline-flex items-center gap-2.5 rounded-lg border border-white/10 bg-white/[.04] px-3 py-2 text-white transition-[border-color,background-color] duration-150 hover:border-white/25 hover:bg-white/[.08]"
                >
                  <span aria-hidden="true" className="grid size-[26px] flex-shrink-0 place-items-center rounded-md bg-white">
                    <Image src="/assets/brand/contact/gmail.svg" alt="" width={18} height={18} className="size-[18px]" />
                  </span>
                  <span className="flex flex-col">
              ...
              <li>
                <a
                  ...
                  className="group inline-flex items-center gap-2.5 rounded-lg border border-white/10 bg-white/[.04] px-3 py-2 text-white transition-[border-color,background-color] duration-150 hover:border-white/25 hover:bg-white/[.08]"
                >
                  <Image src="/assets/brand/contact/googlemaps.svg" alt="" width={26} height={26} className="size-[26px] flex-shrink-0 rounded-md" />
                  <span className="flex flex-col">
