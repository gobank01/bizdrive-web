    ...
    >
      <ul className="grid grid-cols-3 gap-1 p-1.5">
        <li>
          ...
          >
            <Image src="/assets/brand/contact/phone.svg" alt="" width={22} height={22} className="size-[22px] rounded-md" />
        ...
        <li>
          ...
          >
            <svg viewBox="0 0 24 24" aria-hidden="true" className="size-5 fill-none stroke-current [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:1.9]">
