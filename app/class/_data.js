export const PLANS = {
  "manus-ai-online": {
    ...
    hero: {
      ...
      sub: "วิดีโอ + เวิร์กโฟลว์ + เทมเพลตพร้อมใช้ · ปลดล็อก 37 ผู้ช่วย AI ครบทุกแผนก — เรียนเมื่อไหร่ก็ได้ เอาไปใช้กับธุรกิจคุณได้ทันที",
    ...
    bonuses: [
      { title: "🎁 BizDrive AI Workforce — 37 ผู้ช่วย AI พร้อมใช้", valueAmount: 37000, value: "฿37,000", text: "CFO · ทนาย · นักบัญชีภาษี · นักการตลาด · ครีเอทีฟ · โปรแกรมเมอร์ ครบทุกแผนก ทำงาน 24 ชม. + วิดีโอสอนใช้ทีละตัว — คลังเพิ่มสกิลใหม่ให้ตลอด (เปิดให้เฉพาะสมาชิก)" },
  ...
  "manus-ai-seminar": {
    ...
    hero: {
      ...
      sub: "Workshop กลุ่มเล็ก 20 ท่าน · ลงมือทำจริงกับธุรกิจตัวเอง · พี่แบงค์ + ทีม BizDrive โค้ชตรงกับโต๊ะคุณ · แถม 37 ผู้ช่วย AI พร้อมใช้ (CFO · ทนาย · การตลาด · ครีเอทีฟ ครบทุกแผนก)",
    ...
    bonuses: [
      { title: "🎁 BizDrive AI Workforce — 37 ผู้ช่วย AI พร้อมใช้", valueAmount: 37000, value: "฿37,000", text: "CFO · ทนาย · นักบัญชีภาษี · นักการตลาด · ครีเอทีฟ · โปรแกรมเมอร์ ครบทุกแผนก ทำงาน 24 ชม. — พี่แบงค์ติดตั้ง + จูนให้เข้าธุรกิจคุณในคลาส และเพิ่มสกิลใหม่ให้ตลอด (เปิดให้เฉพาะสมาชิก)" },
